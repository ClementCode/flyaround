...
class Flight
{
    ...
    public function __toString()
    {
        ...
        return $this->departure . " -> " . $this->arrival . " Price : " . $this->seatPrice;
    }
    ...
    /**
     * @ORM\ManyToOne(targetEntity="WCS\CoavBundle\Entity\Field", inversedBy="departures")
     * @ORM\JoinColumn(nullable=false)
     */
    private $departure;

    /**
     * @ORM\ManyToOne(targetEntity="WCS\CoavBundle\Entity\Field", inversedBy="arrivals")
     * @ORM\JoinColumn(nullable=false)
     */
    private $arrival;
