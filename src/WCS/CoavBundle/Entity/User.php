...
class User
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="WCS\CoavBundle\Entity\Reviews", mappedBy="reviewAuthor")
     */
     ...
     * Add reviewAuthor
     *
     * @param \WCS\CoavBundle\Entity\Reviews $reviewAuthor
     *
     * @return User
     */
    public function addReviewAuthor(\WCS\CoavBundle\Entity\Reviews $reviewAuthor)
    {
     ...
     * @param \WCS\CoavBundle\Entity\Reviews $reviewAuthor
     */
    public function removeReviewAuthor(\WCS\CoavBundle\Entity\Reviews $reviewAuthor)
    {
