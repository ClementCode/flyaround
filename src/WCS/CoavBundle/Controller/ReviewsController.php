...
class ReviewsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $reviews = $em->getRepository('WCSCoavBundle:Reviews')->findAll();
    ...
    {
        $review = new Reviews();
        $form = $this->createForm('WCS\CoavBundle\Form\ReviewsType', $review);
    ...
    {
        $deleteForm = $this->createDeleteForm($review);
        $editForm = $this->createForm('WCS\CoavBundle\Form\ReviewsType', $review);
